    ...
    <div className={styles.rootCont} id="hero">
      <Fade>
        <div className={styles.nameCont}>
          ...
          <a
            href=
            // "https://docs.google.com/document/d/1JCUOrJLUYvrWgtRluT1Ns1Wg5zPSKsLy/edit?usp=sharing
            // &ouid=113895873573374093110&rtpof=true&sd=true"
            "https://drive.google.com/file/d/1mBBfMeXqExjMC9514lhze3T_7C_aURKv/view?usp=sharing"
            target="_blank"
        ...
        <div className={styles.socialCont}>
          ...
          <a
            rel="noreferrer"
            href="https://github.com/GaneshAher1997"
            className={classes.a}
            target="_blank"
          >
